...
export class ChatRoomComponent implements OnInit {
  ...
  constructor(
    ...
    $("#groupsNavDrop").click(function(){
      $("#chatIDBox").hide();
      $("#groupChatIDBox").show();
   });

   $("#chatsNavDrop").click(function(){
     $("#chatIDBox").show();
     $("#groupChatIDBox").hide();
  });  
  ...
  public leavedChatRoomFunction: any = () => {
    ...
    this.socketService.leavedChatRoom().subscribe((data) => {
        ...
        ////console.log(data);
        console.log(data)
        this.toastr.success(`${data.userName} Leaved the Chat Room`)
  ...
  public deletedChatRoomFunction: any = () => {
    ...
    this.socketService.deletedChatRoom().subscribe((data) => {
        ...
        //console.log(data);
        console.log(data)
        this.toastr.success(`${data.userName} Deleted the Chat Room`)
  ...
  public deleteChatRoom: any = () => {
    if (!this.receiverId) {
      ...
      this.chatRoomTitle='';
      this.toastr.success(this.chatRoomTitle+''+'Room deleted')
      setTimeout(() => {
        this.gotoChat();
      }, 1000);
  ...
  public shareChatRoom: any = () => {
    if (!this.receiverId) {
      ...
      this.toastr.success('Invite Link sent to the entered email id');
      setTimeout(() => {
        this.gotoChat();
      }, 1000);
    }//End condition
